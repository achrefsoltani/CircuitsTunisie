            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    if (p.equals(sha256(strPwd))){
                        ...
                        {
                            Intent a = new Intent(getApplicationContext(), VisiteurActivity.class);
                            startActivity(a);
                    ...
                    _txtLogin.setText("");
                    _txtPassword.setText("");
                    Toast.makeText(getApplicationContext(),"Verifier Login et Mot de passe",Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
            }
        });
        ...
        _btnInscription.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    _txtLogin.setText("");
                    _txtPassword.setText("");
                    Toast.makeText(getApplicationContext(),"Compte Crée avec success",Toast.LENGTH_SHORT).show();
                    e.printStackTrace();
                }
            }
        });
